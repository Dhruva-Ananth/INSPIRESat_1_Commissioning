...
class IS1_UHF_SDR_v1_IIST(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "IS1_UHF_SDR_v1_IIST")
        ...
        self.rx_samp_rate = rx_samp_rate = system_clock/100
        ...
        self.pfb_arb_resampler_xxx_0_2 = pfb.arb_resampler_ccf(
        	  1.0*re_samp_rate/rx_samp_rate,
                  taps=None,
        	  flt_size=32)
        self.pfb_arb_resampler_xxx_0_2.declare_sample_delay(0)

        self.low_pass_filter_0_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, rx_samp_rate, cutoff, 2e3, firdes.WIN_BLACKMAN, 6.76))
        self.gpredict_doppler_0 = gpredict.doppler(tx_freq, rx_freq, self.set_corr_tx_freq, self.set_corr_rx_freq, self.set_rx_freq, "localhost", 4532, False)
        ...
        self.blocks_socket_pdu_0_0 = blocks.socket_pdu("TCP_CLIENT", '#Host ip address', '#port number', 10000, True)
        ...
        self.LO = analog.sig_source_c(rx_samp_rate, analog.GR_COS_WAVE, 100000+rx_freq-corr_rx_freq, 1, 0)
    ...
    def set_system_clock(self, system_clock):
        ...
        self.set_rx_samp_rate(self.system_clock/100)
    ...
    def set_rx_samp_rate(self, rx_samp_rate):
        ...
        self.pfb_arb_resampler_xxx_0_2.set_rate(1.0*self.re_samp_rate/self.rx_samp_rate)
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.rx_samp_rate, self.cutoff, 2e3, firdes.WIN_BLACKMAN, 6.76))
        self.LO.set_sampling_freq(self.rx_samp_rate)
...
def main(top_block_cls=IS1_UHF_SDR_v1_IIST, options=None):
